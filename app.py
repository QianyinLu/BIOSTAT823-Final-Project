    ...
    if selection == "Visualization":
        ...
        if session == "Race":
            ...
            if choice == "Fatality Case":
                ...
                with st.beta_expander("See Detail"):
                    st.write("""
                    Compared to the infection cases, there is obvious difference between the number of cases of female and male, that male has more death cases for almost all races.
                    Among all, Asian has the lowest death rate; on the other hand, Hawaiian has a higher rate of death compared to infection rate, this might be due to the limitation of data size.
            ...
            if choice == "Infection Case":
                ...
                with st.beta_expander("See Detail"):
                    st.write("""
                    Out of 74996 individuals, White/Non-Hispanic as well as Black/Non-Hispanic have the largest death count, the highest is around 1800 (White/Non-Hispanic). There is no obvious differnece between male and female.
                    However, White, Asian and Native Hawaiian have much lower infection rate compared to other races, this situation might be contributted by geographic location, medical condition as well as the awareness of epidemic prevention.
                    American Indian has the highest infection rate, medical contidition might be the major factor. 
                 """)
        ...
        if session == "Age Group":
            ...
            if choice == "Fatality Case":
                ...
                with st.beta_expander("See Detail"):
                    st.write("""
                    Compared to infection cases, the death cases has a more obvious and straight information: people over 70 have a much larger death rate, they have a very high possibility once they got Covid-19.
                 """)
            if choice == "Infection Case":
                ...
                with st.beta_expander("See Detail"):
                    st.write("""
                    The infection counts of each age group is almost proportional to their proportion of total population. And the infection rate increases as population's age increases until 70, indicating
                    younger population’s immune system do perform stronger. For people older than 70, infection rates decrease, and this might be caused by the limitation of their ability of outdoor activities, and this prevents them
                    from many dangerous cases.
                 """)
